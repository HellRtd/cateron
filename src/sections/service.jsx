  ...
  <section id="serv">
    ...
    <article className="container-fluid">    
      <div className="row align-items-center">
        ...
        <Controller>
          <Scene duration={1200}  offset={50} classToggle="active" triggerElement="#event_planing" triggerHook="onEnter"reverse={true} indicators={false}>    
    ...
    <article className="container-fluid mt-md-5 mt-1">    
      <div className="row align-items-center justify-content-end">
        ...
        <div className="col-md-6 text-md-right" id="catering">
          <Controller>
            <Scene duration={1200}  offset={50} classToggle="active" triggerElement="#catering" triggerHook="onEnter" reverse={true} indicators={false}>    
